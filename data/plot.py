...
# Combine Throughput Ratio and Packet Loss Percentage
axs[0].plot(nodes_disconnected, throughput_ratio, marker='o', linestyle='-', color='b', label='Throughput to Bandwidth Ratio')
axs[0].plot(nodes_disconnected, packet_loss, marker='o', linestyle='-', color='g', label='Packet Loss Percentage')
axs[0].set_title('Throughput to Bandwidth Ratio and Packet Loss')
axs[0].set_xlabel('Nodes Disconnected')
axs[0].set_ylabel('Percentage (%)')
axs[0].set_xticks(nodes_disconnected)
axs[0].legend()

# Combine Mean Delay and Mean Jitter
axs[1].plot(nodes_disconnected, mean_delay, marker='o', linestyle='-', color='y', label='Mean Delay')
axs[1].plot(nodes_disconnected, mean_jitter, marker='o', linestyle='-', color='m', label='Mean Jitter')
axs[1].set_title('Mean Delay and Mean Jitter')
axs[1].set_xlabel('Nodes Disconnected')
axs[1].set_ylabel('Time (ms)')
axs[1].set_xticks(nodes_disconnected)
axs[1].legend()
